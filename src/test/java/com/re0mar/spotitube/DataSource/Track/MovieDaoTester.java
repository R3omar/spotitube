...
public class MovieDaoTester {
    ...
    @Test
    public void MovieDaoFindsAllIsZero() {
    ...
    @Test
    public void MovieDaoAddSpecificIsOne() {
        Assertions.assertEquals(0, sut.addSpecific(new String[]{"1","test", "test", "test", "543", "111", "test", "1", "0"}).size());
    }

    @Test
    public void MovieDaoFindsAllIsOne() {
        sut.addSpecific(new String[]{"1","test", "test", "test", "543", "111", "test", "1", "0"});
        Assertions.assertEquals(0, sut.findAll().size());
    }

    @Test
    public void MovieDaoMakesEmptyResultSet() throws SQLException{
        ...
        when(mock.getString("description")).thenReturn("t");
